            ...
            <div id="content" style="width: 100%">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        if($hasil['role']=='3'):
                        ?>
                        <h1 class="h3 mb-0 color">Edit User</h1>
                        <?php endif;?>
                    </div>
                    <?php if($usr=='1'):?>
                    ...
                    <form class="user" action="" method="POST">
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" id="role" name="role" 
                                placeholder="Nama Lengkap" value="<?= $hasil['role']?>" hidden>
                        ...
                        <div class="form-group">
                            <input type="date" class="form-control form-control-user" id="tgl_lahir" name="tgl_lahir" 
                                placeholder="Tanggal lahir" value="<?= $hasil['tgl_lahir']?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="number" class="form-control form-control-user" id="no_hp" name="no_hp" placeholder="No HP" value="<?= $hasil['no_hp']?>">
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="form-control form-control-user" id="pekerjaan" name="pekerjaan" placeholder="Pekerjaan" value="<?= $hasil['pekerjaan']?>">
                            </div>
                        </div>
                        <div class="form-group">
