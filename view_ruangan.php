...
<body id="page-top">
                          ...
                          <center>
                            ...
                            <div class="col">
                              ...
                              ?>
                                ...
                                <option value="2" selected>Ruangan 2</option>
                                <option value="3">Ruangan 3</option>
                                <option value="4">Ruangan 4</option>
                              <?php
                                }
                              ...
                              ?>
                                <option value="1">Ruangan 1</option>
                                <option value="2">Ruangan 2</option>
                                <option value="3" selected>Ruangan 3</option>
                                <option value="4">Ruangan 4</option>
                              <?php
                                }
                                else{
                              ?>
                                ...
                                <option value="2">Ruangan 2</option>
                                <option value="3">Ruangan 3</option>
                                <option value="4" selected>Ruangan 4</option>
                              <?php
                              }
                              ?>
                              </select>
    ...
    <script type="text/javascript">
        ...
        var myLineChart = new Chart(ctx, {
          ...
          data: {
            labels: [<?php
                $sql = "SELECT * FROM (SELECT * FROM arduino ORDER BY id DESC LIMIT 30) sub WHERE ruangan=$ruangan ORDER BY id ASC";
                $row = $db->prepare($sql);
                $row->execute();
                $hasil = $row->fetchAll();
                foreach($hasil as $b){
